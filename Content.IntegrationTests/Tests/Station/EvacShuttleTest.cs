...
public sealed class EvacShuttleTest
{
    ...
    public async Task EmergencyEvacTest()
    {
        ...
        pair.Server.CfgMan.SetCVar(CCVars.GameMap, "Dev"); // Ember: Saltern went with the upstream station maps
        ...
        var stationGrid = data.Grids.First(); // Ember: the Lavaland outpost filter went with that module
