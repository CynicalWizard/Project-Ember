...
job-supervisors-ember-observatory = the Observatory
...
job-name-ember-scg-representative = SolGov Representative
...
department-EmberSecurity = Security
department-EmberSecurity-description = The Fleet detachment aboard: the only people on the ship who may lawfully use force on it. Seconded because the government would not pay for a second armed service.

job-supervisors-ember-chief-of-security = the Chief of Security
job-supervisors-ember-security = the security detachment
job-supervisors-ember-corpsman = the Chief of Security, and the Chief Medical Officer for anything clinical

job-name-ember-chief-of-security = Chief of Security
job-description-ember-chief-of-security = Command the Fleet detachment. Your service decides what you wear and how you are promoted; the Captain decides what you do. Discipline, the armoury, and every decision that will be read back at an inquiry.

job-name-ember-brig-chief = Brig Chief
...
department-EmberEngineering = Engineering
department-EmberEngineering-description = The reactor, the hull and the air. Everything that kills the whole crew at once if it stops.

job-supervisors-ember-chief-engineer = the Chief Engineer
job-supervisors-ember-engineering = the Senior Engineer and the Chief Engineer

job-name-ember-chief-engineer = Chief Engineer
job-description-ember-chief-engineer = Answer for the reactor, the hull and the air. You know the power plant better than anyone aboard and the air worse than your atmospheric technician, and both of those are on purpose.

job-name-ember-senior-engineer = Senior Engineer
...
job-name-ember-engineer-damage-control = Damage Control Technician
job-description-ember-engineer-damage-control = Fire, flooding, breaches. You are not there for repairs; you are there for the ten minutes in which repairs are still possible.

job-name-ember-engineer-electrician = Electrician
...
job-name-ember-pharmacist-chemist = Chemist
job-description-ember-pharmacist-chemist = The same bench, working to order rather than to a formulary. If someone needs a compound that is not on the shelf, they need you.

job-name-ember-medical-technician = Medical Technician
job-description-ember-medical-technician = The infirmary's hands. Treat, dress, monitor, and hand the surgeon what the surgeon asks for. Keep them alive; someone else opens them.

job-name-ember-medical-trainee = Medical Trainee
job-description-ember-medical-trainee = Aboard to learn. Fetch, watch, and get very good at the things nobody senior wants to do, because that is most of medicine.

job-name-ember-medical-resident = Medical Resident
job-description-ember-medical-resident = A qualified doctor still learning to be one. You may assist, you may close, and you are not the one who decides. Say so early and often.

department-EmberScience = Science
department-EmberScience-description = The reason the ship was sent. A laboratory and a field team under one head — everything else aboard keeps them working.

job-supervisors-ember-chief-science-officer = the Chief Science Officer
job-supervisors-ember-laboratory = the Senior Researcher and the Chief Science Officer
...
job-supervisors-ember-executive-officer = the Executive Officer
job-supervisors-ember-supply = the Supply Chief

job-name-ember-supply-chief = Supply Chief
...
job-supervisors-ember-housekeeping = the Chief Steward

job-name-ember-chief-steward = Chief Steward
...
job-name-ember-sanitation-technician = Sanitation Technician
job-description-ember-sanitation-technician = Keep a sealed metal box with forty people in it habitable. Thankless until the week you are not there.

job-name-ember-crewman = Crewman
job-description-ember-crewman = A rating with no speciality, sent wherever hands are short. Every department's dull half is yours, and it will still be yours next cruise.

department-EmberUnattached = Unattached Personnel
...
job-name-ember-off-duty-watch = Off-Duty Watch
job-description-ember-off-duty-watch = A day off. Your service, your rank and everything you know are exactly where you left them; the duties and the doors are not. Go and be a person for a shift.

# English draws no distinction here; all three forms are the same word. The keys exist so that
# languages which do draw one have somewhere to put it.
