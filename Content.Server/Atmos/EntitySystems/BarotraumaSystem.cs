        ...
        public override void Update(float frameTime)
        {
            ...
            while (enumerator.MoveNext(out var uid, out var barotrauma, out var damageable))
            {
                ...
                if (pressure <= Atmospherics.HazardLowPressure)
                {
                    ...
                    _damageableSystem.TryChangeDamage(uid, barotrauma.Damage * Atmospherics.LowPressureDamage, true, false, canSever: false, doPartDamage: false); // Ember
                ...
                else if (pressure >= Atmospherics.HazardHighPressure)
                {
                    ...
                    _damageableSystem.TryChangeDamage(uid, barotrauma.Damage * damageScale, true, false, canSever: false, doPartDamage: false); // Ember
