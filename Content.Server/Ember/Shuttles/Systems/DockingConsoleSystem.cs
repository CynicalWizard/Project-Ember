...
using Content.Shared.Ember.Shuttles;
using Content.Shared.Ember.Shuttles.Components;
using Content.Shared.Ember.Shuttles.Systems;
...
namespace Content.Server.Ember.Shuttles.Systems;
...
public sealed class DockingConsoleSystem : SharedDockingConsoleSystem
{
    ...
    // Ember: the mining shuttle grid moved out of the Lavaland map set with that module.
    // Point this at an Ember shuttle once one exists.
    private static readonly ResPath MiningShuttlePath = new ResPath("/Maps/Shuttles/mining.yml");
