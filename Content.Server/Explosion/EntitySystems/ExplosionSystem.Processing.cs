        ...
        EntityUid? cause)
    {
        if (originalDamage != null)
        {
            ...
            foreach (var (entity, damage) in _toDamage)
            {
                ...
                _damageableSystem.TryChangeDamage(entity, damage * _damageableSystem.UniversalExplosionDamageModifier, ignoreResistances: true, partMultiplier: 0.3f); // Ember: Temp change, nerf explosion delimbing
